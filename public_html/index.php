                                ...
                                <div class="collapse navbar-collapse" id="myNavbar">
                                    <ul class="nav navbar-nav">
                                        <li><form style="padding: 10pt; height: auto;" class="form-inline">
                                                ...
                                                <div class="btn-group">
                                                    <a class="btn ribbon" href="inserirAnuncio.html"><button style="margin-top: -20px; width: 140px; height: 40px; margin-left: -20px;" type="button" class="btn btn-success ribbon">Anuncie Ja!</button></a>
