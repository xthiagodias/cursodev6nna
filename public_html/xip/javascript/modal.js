...
var modal = (function(){
  ...
  var $close = $('<button role="button" class="modal_close" title="Fechar Janela"><span></span></button>');
  ...
  $close.on('click', function(e){
    self.location = "login.php?perfil";
    $(window).open('index.php'); //This will open Google in a new window.
